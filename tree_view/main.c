...
void
row_selected (GtkWidget * wid, gpointer ptr)
{
	...
	if (FALSE != gtk_tree_selection_get_selected(sel, &model, &iter))
	{
...
main (int argc, char * argv[])
{
	...
	g_signal_connect(tv, "cursor-changed",
					 G_CALLBACK(row_selected), NULL);
